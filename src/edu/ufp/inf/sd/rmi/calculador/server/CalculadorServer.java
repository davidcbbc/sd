...
public class CalculadorServer {
     ...
     */
    private CalculadorRI calculadorRI;

    public static void main(String[] args) {

        if (args != null && args.length < 3) {
            System.err.println("usage: java [options] edu.ufp.sd.helloworld.server.CalculadorServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
            //1. ============ Create Servant ============
            CalculadorServer hws = new CalculadorServer(args);
     ...
     * @param args 
     */
    public CalculadorServer(String args[]) {
        try {
            //============ List and Set args ============
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                calculadorRI = new CalculadorImpl();
                ...
                //============ Rebind servant ============
                //Naming.bind(serviceUrl, calculadorRI);
                registry.rebind(serviceUrl, calculadorRI);
